    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        if (void 0 === l && (l = this, -1 == document.cookie.indexOf("cookie_notice"))) {
            ...
            var n = function e(t, o) {
                for (var i in o) o.hasOwnProperty(i) && ("object" == typeof t[i] ? t[i] = e(t[i], o[i]) : t[i] = o[i]);
                return t
            }(p, arguments[0] || t || {});
            n.debug && console.warn("cookie-notice:", n);
            var e, i, r, a, s = function (e, t, o, i, n, r) {
            ...
            c.addEventListener("click", function (e) {
                var t, o, i;
                e.preventDefault(), t = 60 * parseInt(n.expiresIn + "", 10) * 1e3 * 60 * 24, o = new Date, (e = new Date).setTime(o.getTime() + t), document.cookie = "cookie_notice=1; expires=" + e.toUTCString() + "; path=/;", (i = s).style.opacity = 1, i.setAttribute("data-test-transitioning", "true"),
                    function e() {
